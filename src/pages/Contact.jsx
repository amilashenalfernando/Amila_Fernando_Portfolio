        ...
        <div className="w-full max-w-6xl mx-auto pt-10 px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="https://wa.me/94711237591" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-orange-400 transition-colors">
                                    +94 71 123 7591
                                </a>
                            </div>
                        </div>
                ...
                <motion.div
                    ...
                    className="glass-card p-8 md:p-10 border border-white/5 bg-[#0a0a0a]/50 h-fit"
                >
